...
#define CCCR_VALUE        0x00000162		// |0010|0100|0001 0x241 
...
#ifdef XHYPER255A 	//SDRAM 32MB
#define MDCNFG_VALUE      0x00001AA9//0x0B000BC9
#else			//SDRAM 64MB
#define MDCNFG_VALUE      0x00001AC9
#endif

#define MDREFR_VALUE     0x000BC018// 0x020DF016//0x03CDF016//0x000BC018//0x00038016
//#define MDREFR_VALUE      0x000BC018 //SDRAM 50MHz for test board

#ifdef XHYPER255A //CS0# 16bit
#define MSC0_VALUE        0x7ff87ff8//0xFFF03FF0//0x23F223F2//0x3FF83FF0
#else		  //CS0# 32bit
#define MSC0_VALUE        0x7ff87ff0//0xFFF03FF0//0x23F223F2//0x3FF83FF0
#endif

#define MSC1_VALUE        0x7ff87ff8//0x5aa05aa8//0x12BC8240//0x5AA85AA8
#define MSC2_VALUE        0x7ff87ff0//0x24482440
