...
///// Package Information /////////////////////////////////////////////////////
#ifdef XHYPER255A
#define PACKAGE				"XHYPER255A"	// Name of package.
#define VERSION				"R1"		// Version number of package.
#else
#define PACKAGE				"XHYPER255B"	// Name of package.
#define VERSION				"R1"		// Version number of package.
#endif
...
#define ROOT_SRAM_BASE                  (0x002C0000)
#define ROOT_DRAM_BASE			(0xA0000000)
#ifdef XHYPER255A
//#define ROOT_MAX_SIZE			(0x00E00000)
#define ROOT_MAX_SIZE			(0x00D00000)
#else
//#define ROOT_MAX_SIZE			(0x01E00000)
#define ROOT_MAX_SIZE			(0x01D00000)
#endif
...
#ifdef XHYPER255A
#define RAMDISK_DRAM_BASE               (0xA0800000)
#else
#define RAMDISK_DRAM_BASE               (0xA1000000)
#endif
#define NUM_RAMDISK_BLOCKS              (RAMDISK_MAX_LEN / SRAM_BLOCK_SIZE)

///// Newwork /////////////////////////////////////////////////////////////////
#define CLIENT_ETHER			{0x58, 0x82, 0x82, 0x82, 0x58, 0x58}
