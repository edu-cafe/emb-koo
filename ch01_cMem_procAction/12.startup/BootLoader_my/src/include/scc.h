...
#define	IO_BASE			0x04000300
#define IO_RTX_DATA		*((volatile short *)(IO_BASE + 0x00000000))	// RTx data.
#define IO_TXCMD		*((volatile short *)(IO_BASE + 0x00000004))	// RTx command.
#define IO_TXLEN		*((volatile short *)(IO_BASE + 0x00000006))	// transmit length.
#define IO_ISQ			*((volatile short *)(IO_BASE + 0x00000008))	// interrupt.
#define IO_PPPTR		*((volatile short *)(IO_BASE + 0x0000000a))	// packet page point.
#define IO_PPDATA		*((volatile short *)(IO_BASE + 0x0000000c))	// packet page data.
...
// ID.
#define PP_ChipID					0x0000	// First Chip ID.  CS8900A : 0x630E
#define PP_ChipID2					0x0002	// Second Chip ID. CS8900A : 0x0800
