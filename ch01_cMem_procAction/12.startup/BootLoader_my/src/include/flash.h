...
#define CMD_TBL_FLASH																				\
				...
				"  flash {loader/kernel/root/ramdisk}       Copy to Flash from SDRAM of Area.\n"  \
				"  flash [dest] [src] [len]                 Copy to Flash from src to dest.\n",	  \
				"  flash {loader/kernel/root/ramdisk}       Copy to Flash from SDRAM.\n",	  \
				"  flash {loader/kernel/root/ramdisk}       Copy to Flash from SDRAM of Area.\n"  \
				"  flash [dest] [src] [len]                 Copy to Flash from src to dest.\n"	  \
				}
...
#define CMD_TBL_ERASE																				\
				...
				"  erase {loader/kernel/root/ramdisk}       Erase Flash Blocks of Area.\n",	\
				0,										\
				"  erase [addr]                             Erase One Flash Block.\n"		\
				"  erase [addr] [len]                       Erase Flash Blocks.\n"		\
				"  erase {loader/kernel/root/ramdisk}       Erase Flash Blocks of Area.\n"	\
...
#define CMD_TBL_LOCK																				\
				...
				"  lock {loader/kernel/root/ramdisk}        Set Flash Lock-Bit of Area.\n",	\
				"  lock {loader/kernel/root/ramdisk}        Set Flash Lock-Bit of Area.\n",	\
				"  lock [addr]                              Set Flash Lock-Bit of One Block.\n"	\
				"  lock [addr] [len]                        Set Flash Lock-Bit of Blocks.\n"	\
				"  lock {loader/kernel/root/ramdisk}        Set Flash Lock-Bit of Area.\n"	\
